            ...
            foreach (var field in fields)
            {
                ...
                if (attribute != null)
                {
                    ...
                    if (enumerable != null)
                    {
                        ...
                        if (attribute.CountLessThan > -1 && count >= attribute.CountLessThan)
                        {
                            throw JsonCountException.CreateLessThanException(list, attribute.CountLessThan);
                        }
                        if (attribute.CountGreaterThan > -1 && count <= attribute.CountGreaterThan)
                        {
                            throw JsonCountException.CreateGreaterThanException(list, attribute.CountGreaterThan);
                        }
                    }
                    // 使用自定义序列化。
