...
namespace Common.Serialization.Json
{
    internal class JsonSerializerV2
    {
        ...
        internal string GetSerializeResult(object obj)
        {
        ...
        private void SerializeClassProperty(object obj, PropertyInfo property, HashSet<string> outputKeys)
        {
            ...
            var attribute = property.GetCustomAttribute<JsonAttribute>();
            string key;
            object value;
            if (attribute != null)
            {
        ...
        private void SerializeLazy(object lazy, Type lazyType)
        {
            ...
            SerializeObject(new
            {
                IsValueCreated = isValueCreatedProperty.GetValue(lazy),
                Value = valueProperty.GetValue(lazy)
            });
        }
